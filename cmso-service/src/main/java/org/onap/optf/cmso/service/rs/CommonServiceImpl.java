...
public class CommonServiceImpl extends BaseSchedulerServiceImpl  {
    ...
    protected void createSchedule(OptimizedScheduleMessage scheduleMessage, String scheduleId, HttpServletRequest request)
     ...
     */
    private boolean validate(OptimizedScheduleMessage scheduleMessage, Map<String, List<ElementInfo>> groups) throws CMSException {
    ...
    private void createChangeManagement(Schedule schedule, OptimizedScheduleMessage scheduleMessage, Map<String, List<ElementInfo>> groups) throws CMSException {
    ...
    private void createChangeManagementImmediate(Schedule schedule, OptimizedScheduleMessage scheduleMessage, Map<String, List<ElementInfo>> groups) throws CMSException, JsonProcessingException {
        SchedulingData schedulingInfo = scheduleMessage.getSchedulingData();
        for (String groupId : groups.keySet())
        {
            ChangeManagementGroup cmg = new ChangeManagementGroup();
    ...
    protected void processApproveScheduleRequest(Schedule s, ApprovalMessage approval, List<DomainData> domainData)
            throws CMSException {
