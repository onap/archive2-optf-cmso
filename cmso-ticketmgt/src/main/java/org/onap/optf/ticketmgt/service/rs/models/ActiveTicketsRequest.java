...
@ApiModel(value = "Ticket Management Request", description = "Details and scheduling criteria for the VNFs to be changed.")
public class ActiveTicketsRequest implements Serializable {
    ...
    private List<ElemenentCriteria> elements = new ArrayList<>();
	...
	public List<ElemenentCriteria> getElements() {
		return elements;
	}


	public void setElements(List<ElemenentCriteria> elements) {
