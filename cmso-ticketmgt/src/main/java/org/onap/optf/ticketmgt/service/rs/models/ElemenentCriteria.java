...
@ApiModel(value = "Element Critera", description = "Element criteria for getting active tickets.")
public class ElemenentCriteria implements Serializable {
    private static final long serialVersionUID = 1L;

    @ApiModelProperty(value = "Element id as it is know to the ticket management system.")
