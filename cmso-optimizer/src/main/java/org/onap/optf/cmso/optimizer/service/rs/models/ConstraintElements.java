...
@ApiModel(value = "Topology Constraint Elements", description = "Constraining Element Information returned from TopologyRequuest.")
public class ConstraintElements implements Serializable {
    ...
    @ApiModelProperty(value = "If more than one instance of constraintType, minimum number of available instances required."
