...
public class OptimizerInterfaceImpl  implements OptimizerInterface {
	...
	@Override
	public Response optimizeSchedule(String apiVersion, OptimizerRequest activeTicketsRequest) 
	{
		// TODO Auto-generated method stub
		String id = activeTicketsRequest.getRequestId();
        Observation.report(LogMessages.OPTIMIZE_SCHEDULE, "Received", request.getRemoteAddr(), id, "");
...
//            response = Response.status(e.getStatus()).entity(e.getRequestError()).build();
        ...
        Observation.report(LogMessages.OPTIMIZE_SCHEDULE, "Returned", request.getRemoteAddr(), id, response.getStatusInfo().toString());
		return response;
	}
	...
	public Response getPolicies(String apiVersion) {
		// TODO Auto-generated method stub
        Observation.report(LogMessages.GET_POLICIES, "Received", request.getRemoteAddr(), "", "");
        Response response = null;
        try 
        {
...
//            response = Response.status(e.getStatus()).entity(e.getRequestError()).build();
        ...
        Observation.report(LogMessages.GET_POLICIES, "Returned", request.getRemoteAddr(), "", response.getStatusInfo().toString());
		return response;
	}
	...
	public Response getSchedule(String apiVersion, String id) {
		// TODO Auto-generated method stub
        Observation.report(LogMessages.GET_SCHEDULE, "Received", request.getRemoteAddr(), id, "");
        Response response = null;
        try 
        {
        	OptimizerResponse atr = new OptimizerResponse();
...
//            response = Response.status(e.getStatus()).entity(e.getRequestError()).build();
        ...
        Observation.report(LogMessages.GET_SCHEDULE, "Returned", request.getRemoteAddr(), id, response.getStatusInfo().toString());
		return response;
	}
	...
	public Response deleteSchedule(String apiVersion, String id) {
		// TODO Auto-generated method stub
        Observation.report(LogMessages.DELETE_SCHEDULE, "Received", request.getRemoteAddr(), id, "");
        Response response = null;
        try 
        {
        	OptimizerResponse atr = new OptimizerResponse();
...
//            response = Response.status(e.getStatus()).entity(e.getRequestError()).build();
        ...
        Observation.report(LogMessages.DELETE_SCHEDULE, "Returned", request.getRemoteAddr(), id, response.getStatusInfo().toString());
		return response;
	}
}
