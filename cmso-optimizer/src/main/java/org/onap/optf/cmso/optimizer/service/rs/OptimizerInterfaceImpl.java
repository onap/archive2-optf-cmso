...
public class OptimizerInterfaceImpl implements OptimizerInterface {
    ...
    public Response optimizeSchedule(String apiVersion, OptimizerRequest activeTicketsRequest) {
        ...
        Observation.report(LogMessages.OPTIMIZE_SCHEDULE, "Returned", request.getRemoteAddr(), id,
    ...
    public Response getPolicies(String apiVersion) {
        ...
        Observation.report(LogMessages.GET_POLICIES, "Returned", request.getRemoteAddr(), "",
                        response.getStatusInfo().toString());
        return response;
    }
    ...
    public Response getSchedule(String apiVersion, String id) {
        ...
        Observation.report(LogMessages.GET_SCHEDULE, "Returned", request.getRemoteAddr(), id,
                        response.getStatusInfo().toString());
        return response;
    }
    ...
    public Response deleteSchedule(String apiVersion, String id) {
        ...
        Observation.report(LogMessages.DELETE_SCHEDULE, "Returned", request.getRemoteAddr(), id,
                        response.getStatusInfo().toString());
        return response;
    }
}
